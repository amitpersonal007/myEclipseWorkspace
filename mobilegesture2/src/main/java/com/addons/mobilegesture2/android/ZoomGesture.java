...
public class ZoomGesture extends AndroidAction {
    ...
    protected com.testsigma.sdk.Result execute() throws NoSuchElementException {
        ...
        try {
            ...
            final Sequence pinchAndZoom1 = new Sequence((InputSource)finger, 0);
            ...
            pinchAndZoom1.addAction((Interaction)new Pause((InputSource)finger, Duration.ofMillis(100L)));
            ...
            final Sequence pinchAndZoom2 = new Sequence((InputSource)finger2, 0);
            ...
            pinchAndZoom2.addAction((Interaction)new Pause((InputSource)finger, Duration.ofMillis(100L)));
            ...
            for (int scaleIndex = 0; scaleIndex < Integer.parseInt(testData.getValue().toString()); ++scaleIndex) {
                androidDriver.perform((Collection)Arrays.asList(pinchAndZoom1, pinchAndZoom2));
            }
