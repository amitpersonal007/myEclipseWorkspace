...
@Data
@Action(actionText = "Flick Mobile screen to direction directional", applicationType = ApplicationType.ANDROID)
public class MobileFlick extends AndroidAction {



    @TestData(reference = "directional")
    private com.testsigma.sdk.TestData testData;
    @Element(reference = "ui-identifier")
